...
(*****Begin*****)
val n = getInt() and m = getInt(); val graph: (int * int) list array = Array.array(n, []);
fun input i =
let val a = getInt() - 1 and b = getInt() - 1
